...
describe("regex parsers", () => {
  ...
  describe("integration with combinators", () => {
    ...
    it("should work correctly with many1", () => {
      ...
      expect(parser.parseOrThrow("hello123")).toEqual(["h", "e", "l", "l", "o", "1", "2", "3"]);
      expect(Either.isLeft(parser.parse("!!!").result)).toBe(true);
    });
    ...
    it("should work correctly with notFollowedBy", () => {
      const parser = sequence([regex(/hello/), notFollowedBy(regex(/\s+world/))]);
  ...
  describe("complex real-world patterns", () => {
    ...
    it("should parse URLs", () => {
      ...
      expect(parser.parseOrThrow("https://example.com")).toBe("https://example.com");
  ...
  describe("performance and memory", () => {
    it("should not cause infinite loops with star quantifiers", () => {
      ...
      expect(() => parser.parse("aaa")).toThrow("Parser did not advance - infinite loop prevented");
    });
